...
public class Sweets extends Item {
    ...
    public Sweets(int id, int value, String name, String explanation, int price,ShelfLife shelfLife) {
    ...
    public static Sweets createOne() {
        ...
        Sweets newOne = new Sweets(item.getId(), item.getValue(), item.getName(), item.getExplanation(), item.getPrice(),
